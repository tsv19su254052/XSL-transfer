...
def main():
    with saxoncee.PySaxonProcessor(license=True) as Process_Saxon:
        ...
        Output = Process_xslt.transform_to_string(source_file=config_from_cfg.get(section='FileNames', option='xml_input'), stylesheet_file=config_from_cfg.get(section='FileNames', option='xsl_filename'))
